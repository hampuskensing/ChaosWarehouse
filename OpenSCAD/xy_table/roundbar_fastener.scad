...
difference() {
    cube([axle_holder_width-0.75, axle_set_depth-0.75, axle_fastener_height]);
    ...
    translate([axle_holder_width / 2, 0, -1.2]) rotate([270, 0, 0]) cylinder(d = roundbar_diameter, h = 33);
